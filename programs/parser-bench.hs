...
main =
  ...
  [ bgroup "orig"
    ...
    , bgroup "statement" [
        run "throwAway" (parseStatements Orig.parseProgram) (throwAway 500)
        , bgroup "includes"
          [ run "include" (parseStatements Orig.parseProgram) (include 5000)
          , run "use" (parseStatements Orig.parseProgram) (use 5000)
          ]
        , run "assignments" (parseStatements Orig.parseProgram) (assignments 50)
        , run "function declarations" (parseStatements Orig.parseProgram) (functionDeclarations 100)
        , run "echos" (parseStatements Orig.parseProgram) (echos 1000)
        , run "ifs" (parseStatements Orig.parseProgram) (ifs 250)
        , run "fors" (parseStatements Orig.parseProgram) (fors 50)
        , run "module calls" (parseStatements Orig.parseProgram) (moduleCalls 500)
        , run "module declarations" (parseStatements Orig.parseProgram) (moduleDeclarations 500)
        ]
    , bgroup "expression" [
  ...
  ,
    ...
    , bgroup "statement" [
        run "throwAway" (parseStatements Alt.parseProgram) (throwAway 500)
--        , bgroup "includes"
--          [ run "include" (parseStatements Alt.parseProgram) (include 5000)
--          , run "use" (parseStatements Alt.parseProgram) (use 5000)
--          ]
        , run "assignments" (parseStatements Alt.parseProgram) (assignments 50)
        , run "function declarations" (parseStatements Alt.parseProgram) (functionDeclarations 100)
        , run "echos" (parseStatements Alt.parseProgram) (echos 1000)
        , run "ifs" (parseStatements Alt.parseProgram) (ifs 250)
        , run "fors" (parseStatements Alt.parseProgram) (fors 50)
        , run "module calls" (parseStatements Alt.parseProgram) (moduleCalls 500)
        , run "module declarations" (parseStatements Alt.parseProgram) (moduleDeclarations 500)
        ]
    , bgroup "expression" [
        run "ternary operators" parseExpr (ternary 500)
        , run "let statements" parseExpr (lets 3)
