...
buildS3 (Shared3 Empty) = call "union" [] []

buildS3 (Shared3 Full) = buildS3 $ Shared3 $ Complement $ Shared3 Empty
...
buildS2 (Shared2 Empty) = call "union" [] []

buildS2 (Shared2 Full) = buildS2 $ Shared2 $ Complement $ Shared2 Empty
