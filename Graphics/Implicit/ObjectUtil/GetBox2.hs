...
import Prelude(uncurry, Bool, Eq, (==), (||), unzip, minimum, maximum, ($), filter, not, (.), (/), fmap, (-), (+), (*), cos, sin, sqrt, min, max, (<), (<>), pi, atan2, (==), (>), show, (&&), otherwise, error)
...
import Graphics.Implicit.MathUtil (infty, bounding, reflect)
